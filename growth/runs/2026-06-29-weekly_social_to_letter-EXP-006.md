...
**Branch:** cursor/social-campaign-pack-5ddb  
...
| `content/campaigns/.gitkeep` | Scaffold (EXP-034 partial) |
...
- Review draft pack before any off-repo posting
- Produce Pin/Reel assets per shot list
- Rotate bio UTM `utm_content` weekly per campaign doc

## Lock

No code lock used. `state.json` lock_status remains `unlocked`.
