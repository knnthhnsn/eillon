...
**Base ref:** `origin/main` @ `de93013`  
**Commits:** 72

## Summary

Main shipped substantial growth OS scaffolding, three conversion/SEO experiments (EXP-003/004/005), homepage performance and scroll-pin stabilization, editorial/visual upgrades (shaders, letters, wear imagery), and earlier-phase infra (CI, analytics, legal). Baseline updated for new routes and sitemap count.
...
4. Continue mobile pin QA on iOS Safari after normalizeScroll fixes.
