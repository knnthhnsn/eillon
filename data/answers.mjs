...
export const EILLON_ANSWERS = [
  ...
  },
  {
    ...
    shortAnswer:
      'Restock and newsletter forms never take payment. The Beles next-restock page is the only payment path when its status says checkout is open; otherwise its buttons remain disabled.',
    sourcePage: '/shipping',
  ...
  },
  {
    ...
    shortAnswer:
      'Restock sample checkout is limited to Denmark, Sweden, Norway, Germany, France, the United Kingdom, and the United States. Perfume carrier restrictions still apply, and any unavailable route is cancelled and refunded.',
    sourcePage: '/shipping',
  ...
  },
  {
    ...
    shortAnswer:
      'Paid restock samples may be cancelled for a refund before dispatch. After physical delivery, the published returns policy and mandatory consumer rights apply; contact care@eillon.maison to cancel or return.',
    sourcePage: '/shipping',
