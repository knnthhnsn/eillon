window.EILLON_PRODUCTS = [
  {
    ...
    formats: [
      { id: 'sample', label: '2 ml sample', price: 28, currency: 'EUR', status: 'out-of-stock' },
      { id: '50', label: '50 ml', price: 170, currency: 'EUR', status: 'out-of-stock' },
      { id: '100', label: '100 ml', price: 240, currency: 'EUR', status: 'out-of-stock' },
    ],
  },
  {
    slug: 'asmara',
