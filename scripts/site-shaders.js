...
(function () {
  ...
  var TARGETS = [
    ...
    { sel: '.boutique-shader-band--collection', key: 'collectionFrost', mode: 'studioSettle', prepend: true, blend: 'soft-light' },
    { sel: '.boutique-shader-band--answers', key: 'collectionFrost', mode: 'studioSettle', prepend: true, blend: 'soft-light' },
    { sel: '.store-hero-band', key: 'shopHero', mode: 'studioSettle', prepend: true, blend: 'soft-light' },
    ...
    { sel: '.boutique-chapter-band--petricor', key: 'petricorNotes', prepend: true, blend: 'screen' },
    ...
    { sel: '.chapter-shader-band--oliva', key: 'olivaNotes', prepend: true, blend: 'screen' },
  ...
  var THEMES = {
    ...
    peopleFrost:  { c1: [0.10, 0.06, 0.04], c2: [0.68, 0.42, 0.22], c3: [0.98, 0.86, 0.58], opacity: 0.58, baseAlpha: 0.48, scale: 1.18, speed: 0.82, spot: [0.58, 0.42, 0.48, 0.72] },
    ...
    collectionFrost: { c1: [0.42, 0.44, 0.48], c2: [0.62, 0.64, 0.68], c3: [0.88, 0.88, 0.90], opacity: 1, baseAlpha: 0.82, scale: 1.16, speed: 0.76 },
    shopHero:      { c1: [0.44, 0.46, 0.50], c2: [0.64, 0.66, 0.70], c3: [0.90, 0.90, 0.92], opacity: 1, baseAlpha: 0.80, scale: 1.20, speed: 0.80 },
    ...
    olivaNotes:   { c1: [0.10, 0.18, 0.08], c2: [0.38, 0.54, 0.24], c3: [0.88, 0.74, 0.30], opacity: 0.58, scale: 1.18, speed: 1.08 },
    ...
    petricorNotes: { c1: [0.14, 0.20, 0.18], c2: [0.36, 0.52, 0.44], c3: [0.78, 0.84, 0.76], opacity: 0.56, scale: 1.18, speed: 1.05 },
