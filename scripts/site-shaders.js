...
(function () {
  ...
  var TARGETS = [
    ...
    { sel: '.notes.notes--beles', key: 'belesNotes', prepend: true, blend: 'screen' },
    { sel: '.notes.notes--asmara', key: 'asmaraNotes', prepend: true, blend: 'screen' },
    { sel: '.notes.notes--massawa', key: 'massawaNotes', prepend: true, blend: 'screen' },
    { sel: '.notes.notes--ritual', key: 'ritualNotes', prepend: true, blend: 'screen' },
  ...
  var THEMES = {
    ...
    belesNotes:   { c1: [0.22, 0.52, 0.20], c2: [0.58, 0.78, 0.28], c3: [1.0, 0.62, 0.08], opacity: 0.52, scale: 1.28, speed: 1.15 },
    asmaraNotes:  { c1: [0.34, 0.30, 0.26], c2: [0.62, 0.54, 0.44], c3: [0.90, 0.56, 0.28], opacity: 0.50, scale: 1.15, speed: 1.05 },
    massawaNotes: { c1: [0.68, 0.30, 0.08], c2: [0.96, 0.50, 0.14], c3: [0.24, 0.74, 0.68], opacity: 0.52, scale: 1.22, speed: 1.25 },
    ritualNotes:  { c1: [0.36, 0.16, 0.26], c2: [0.62, 0.34, 0.20], c3: [0.98, 0.72, 0.28], opacity: 0.50, scale: 1.12, speed: 0.95 },
