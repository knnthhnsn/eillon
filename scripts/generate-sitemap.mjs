...
const ROUTES = [
  ...
  { path: '/journal/sample-first-niche-perfume', file: 'journal/sample-first-niche-perfume.html', priority: '0.74', changefreq: 'monthly', image: 'images/samples.webp', imageTitle: 'Sample-first niche perfume buying' },
