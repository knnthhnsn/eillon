...
const ROUTES = [
  ...
  { path: '/journal/what-is-a-skin-scent', file: 'journal/what-is-a-skin-scent.html', priority: '0.76', changefreq: 'monthly', image: 'images/close-skin2-1200.webp', imageTitle: 'What is a skin scent' },
