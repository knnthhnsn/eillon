...
const ROUTES = [
  ...
  { path: '/journal/genderless-niche-perfume-copenhagen', file: 'journal/genderless-niche-perfume-copenhagen.html', priority: '0.74', changefreq: 'monthly', image: 'images/about-studio-1400.webp', imageTitle: 'Genderless niche perfume in Copenhagen' },
