...
const ROUTES = [
  ...
  { path: '/journal/what-does-fico-d-india-smell-like', file: 'journal/what-does-fico-d-india-smell-like.html', priority: '0.78', changefreq: 'monthly', image: 'images/palette-desert-fruit.webp', imageTitle: "What does Fico d'India smell like?" },
