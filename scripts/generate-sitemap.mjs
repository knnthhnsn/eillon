...
const ROUTES = [
  ...
  { path: '/skin-scent-parfum', file: 'skin-scent-parfum.html', priority: '0.81', changefreq: 'monthly', image: 'images/close-skin2-1200.webp', imageTitle: 'Skin scent parfum — close-wearing Beles' },
